        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form id="signup_form" onsubmit="return false" class="was-validated">
              ...
              <div class="form-group">
                <input type="text" class="form-control field-border" placeholder="USN" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control field-border" placeholder="Phone Number" required>
              </div>
